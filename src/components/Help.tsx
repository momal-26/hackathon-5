...
const Help = () => {
    return (
        <div className="max-w-screen-2xl  mx-14">
            <div className='form text-center my-6 ' >
                <span className='text-3xl font-semibold my-6 uppercase text-center'>get help</span>
                <div className='flex justify-center'>
                    <input className='w-96 text-xs px-5 py-3 my-2 ' type="text" placeholder='What can we help you with?' /> <button className='relative right-10'>
           ...
           <div className='flex'>
                <div className='faqs px-5 lg:px-11'>
                    ...
                    <div  className='buttons'>
                        <button className="button-help">JOIN US</button>
                        <button className="button-help">SHOP NIKE</button>
                    </div>
